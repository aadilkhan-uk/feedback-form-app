    ...
    <div className={className}>
      ...
      <div className="relative">
        <InputComponent
          ...
          maxLength={maxLength}
          className={`w-full rounded-lg border bg-white/10 px-12 py-4 text-[var(--color-text-white)] transition-all duration-200 placeholder:text-[var(--color-text-muted)] hover:border-white/25 hover:bg-white/15 focus:border-[var(--color-accent-green)] focus:bg-white/15 focus:outline-none ${multiline ? "min-h-[120px] resize-y" : "h-14"} ${maxLength ? "pr-16" : ""} `}
